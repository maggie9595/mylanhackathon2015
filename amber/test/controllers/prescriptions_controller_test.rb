...
class PrescriptionsControllerTest < ActionController::TestCase
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post :create, prescription: { active: @prescription.active, dosage: @prescription.dosage, medication_id: @prescription.medication_id, patient_id: @prescription.patient_id, time: @prescription.time }
    end
  ...
  test "should update prescription" do
    patch :update, id: @prescription, prescription: { active: @prescription.active, dosage: @prescription.dosage, medication_id: @prescription.medication_id, patient_id: @prescription.patient_id, time: @prescription.time }
    assert_redirected_to prescription_path(assigns(:prescription))
  end
